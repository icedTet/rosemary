...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  return (
    <SlideContext.Provider value={slide}>
      ...
      <div className={`${slide === 3 ? `opacity-100 pointer-events-none`:`opacity-0 pointer-events-none`} bg-gray-800 px-4 py-2 absolute bottom-0 left-0 m-3 z-[51] rounded-md transition-all text-gray-100`}
      onClick={() => setSlide(0)}>
      Replay</div>
      <Component {...pageProps} />
